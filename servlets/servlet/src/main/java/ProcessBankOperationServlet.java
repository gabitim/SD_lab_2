...
public class ProcessBankOperationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // se incearca preluarea bean-ului folosind obiectul HttpSession,
        // care pastreaza o sesiune HTTP intre client si server
        ...
        if (bankAccount == null) {
            try {
                ...
                // dupa preluarea bean-ului prin JNDI, obiectul se Context in sesiune pentru a fi refolosit ulterior
